...
func TestTagsRequestWithSuccessfulResponse(t *testing.T) {
	...
	tags, err := tagsRequest(&mockResponse, "http://dockerregistry.com:1123", image, 10)
...
func TestTagsRequestWithImageNotMatchResponse(t *testing.T) {
	...
	image1 := "another name"
	tags, err := tagsRequest(&mockResponse, "http://dockerregistry.com:1123", image1, 10)
...
func TestTagsRequestWithBadStatusCode(t *testing.T) {
	...
	tags, err := tagsRequest(&badStatusCode, "http://dockerregistry.com:1123", image, 10)
...
func TestTagsRequestWithInvalidURL(t *testing.T) {
	...
	repos, err := tagsRequest(req.GetClient(10), badURL, image, 10)
